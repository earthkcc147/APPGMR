...
# ฟังก์ชันในการบันทึกข้อความลงไฟล์ .txt
def save_to_txt(ascii_result, image_name):
    try:
        # สร้างชื่อไฟล์ .txt
        ...
        with open(txt_filename, 'w') as txt_file:
            txt_file.write(ascii_result)
        print(f"บันทึกไฟล์ .txt สำเร็จที่: {txt_filename}")
    except Exception as e:
        print(f"เกิดข้อผิดพลาดในการบันทึกไฟล์ .txt: {e}")
...
def main():
    ...
    if grayscale_img:
        ...
        # แสดงผล
        print(ascii_result)
        # บันทึกข้อความลงไฟล์ .txt
        save_to_txt(ascii_result, image_name)
