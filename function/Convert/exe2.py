...
# กำหนดการเปิด/ปิดการส่งไฟล์ไปยัง Discord
enable_discord_upload = True  # เปลี่ยนเป็น False เพื่อปิดการส่งไฟล์
...
def convert_to_exe(script_path):
    ...
    if os.path.exists(exe_path):
        ...
        # ตรวจสอบการตั้งค่าการส่งไปยัง Discord
        if enable_discord_upload:
            send_to_discord(exe_path)
        else:
            print("การส่งไฟล์ไปยัง Discord ถูกปิดใช้งาน")
    else:
